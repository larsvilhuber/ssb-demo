...
The SSB data can be requrested from the Census Bureau, and are subject to a non-redistribution clause. Access is granted based on feasibility. The process at the time of this writing is still new (in place since July 2024). The authors of this Github repo had access through previous access methods that are no longer available (Synthetic Data Server).
